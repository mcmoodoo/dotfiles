...
-- Buffers TODO: note which mapping pair I use the most intuitively and remove the other
...
vim.keymap.set('n', '<leader>c', ':bdelete!<CR>', opts)   -- close buffer TODO: which one do I use more?
